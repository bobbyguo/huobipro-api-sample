...
//		try {
//			FileOutputStream fos = new FileOutputStream("/tmp/abc.png");
//			ChartUtils.writeChartAsPNG(fos, new CreateJFreeChart().makeLineAndShapeChart("各地汽车销量", "城市", "销量", dataset), 800, 600);
//		} catch (IOException e) {
//			// TODO Auto-generated catch block
//			e.printStackTrace();
//		}
		
		ChartFrame cf = new ChartFrame("test", new CreateJFreeChart().makeLineAndShapeChart("各地汽车销量", "城市", "销量", dataset));
		cf.pack();
		cf.setVisible(true);
	}
}