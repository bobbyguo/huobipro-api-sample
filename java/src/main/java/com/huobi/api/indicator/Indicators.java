package com.huobi.api.indicator;

import java.math.BigDecimal;
import java.util.List;

import com.huobi.api.model.Data;
import com.huobi.api.model.StockConstants;
import com.huobi.api.util.Utils;
...
public class Indicators {
    public Core core;
    static Indicators instance = new Indicators();
    ...
    public List<Data> sma(List<Data> stockDatas){
    ...
    public List<Data> sma(List<Data> stockDatas,int ma){
        return sma(stockDatas,"close",ma);
    }


    public List<Data> sma(List<Data> stockDatas,String column,int ma){
    ...
    public List<Data> ema(List<Data> stockDatas){
    ...
    public List<Data> ema(List<Data> stockDatas,int ma){
        return ema(stockDatas,"close",ma);
    }


    public List<Data> ema(List<Data> stockDatas,String column,int ma){
        double[] doubles = Utils.toDoubleArray(stockDatas,column);
    ...
    public List<Data> macd(List<Data> stockDatas){
        return macd(stockDatas,12, 26, 9);
    }

    public List<Data> macd(List<Data> stockDatas, int optInFastPeriod, int optInSlowPeriod, int optInSignalPeriod){
    ...
    public List<Data> boll(List<Data> stockDatas){
        double[] closes = Utils.toDoubleArray(stockDatas,"close");
    ...
    public List<Data> kdj(List<Data> stockDatas){
